...
class TypeGuesserTest extends TestCase
{
    ...
    public function it_can_guess_url_values()
    {
        ...
        $this->assertEquals('url()', $this->typeGuesser->guess('twitter_url', $this->getType()));
        $this->assertEquals('url()', $this->typeGuesser->guess('endpoint_url', $this->getType()));
    }

    /** @test */
    public function it_can_guess_image_url_values()
    {
        $this->assertEquals('imageUrl()', $this->typeGuesser->guess('image_url', $this->getType()));
    }
    ...
    public function it_can_guess_coordinates_based_on_their_names()
    {
        ...
        $this->assertEquals('longitude()', $this->typeGuesser->guess('longitude', $this->getType()));
    }
